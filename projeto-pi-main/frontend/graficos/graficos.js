    ...
    options: {
      ...
      plugins: {
        title: {
            ...
            text: 'Quantidade de Escolas Com Água Potável, Tratamento de Lixo e Energia da Rede Pública'
        }
    }
    }
  });
      ...
      options: {
        ...
        plugins: {
          title: {
              ...
              text: 'Quantidade de Escolas Com e Sem Computadores'
          }
      }
      }
    });
      ...
      options: {
        ...
        plugins: {
          title: {
              ...
              text: 'Quantidade de escolas com Auditório, Biblioteca, Laboratório de Ciências e Laboratório de Informática'
          }
      }
      }
    });
